...
const response_event_dto_1 = __webpack_require__(26);
const response_reward_dto_1 = __webpack_require__(27);
const response_claim_dto_1 = __webpack_require__(28);
...
let EventController = class EventController {
    ...
    async claimReward(eventId, dto) {
        ...
        const result = await this.claimService.createWithResult({ ...dto, eventId }, alreadyClaimed ? false : passed, alreadyClaimed ? '이미 보상을 수령했습니다' : passed ? '조건 충족' : '조건 불충족');
...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['ON_DEMAND', 'ON_EVENT'], example: 'ON_DEMAND' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'DAILY_LOGIN_365' }),
    __metadata("design:type", String)
], AchievementConditionDto.prototype, "achievementId", void 0);
