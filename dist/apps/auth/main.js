...
const user_schema_1 = __webpack_require__(/*! ./schemas/user.schema */ "./apps/auth/src/schemas/user.schema.ts");
...
__decorate([
    (0, class_validator_1.IsIn)(['USER', 'OPERATOR', 'AUDITOR', 'ADMIN']),
    __metadata("design:type", String)
...
/***/ "./apps/auth/src/schemas/user.schema.ts":
/*!**********************************************!*\
  !*** ./apps/auth/src/schemas/user.schema.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
__decorate([
    (0, mongoose_1.Prop)({ required: true, enum: ['USER', 'OPERATOR', 'AUDITOR', 'ADMIN'], default: 'USER' }),
    __metadata("design:type", String)
